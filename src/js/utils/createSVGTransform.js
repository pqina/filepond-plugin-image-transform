...
export const createSVGTransform = ({ createBlob, renameFile }) => {

    return (item, file, transforms) => new Promise((resolve, reject) => {
...
${originalNode.outerHTML}
            ...
            // create new svg file
            resolve(renameFile(createBlob(transformed, 'image/svg+xml'), file.name));
        }
